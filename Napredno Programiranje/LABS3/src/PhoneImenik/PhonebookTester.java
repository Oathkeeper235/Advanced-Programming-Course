...
class Contact implements Comparable<Contact> {
    ...
    public Contact(String name, String... phoneNumber) throws InvalidNameException, InvalidNumberException, MaximumSizeExceededException {
        ...
        if (!Arrays.stream(phoneNumber).allMatch(this::phoneNumberCheck)) {
        ...
        IntStream.range(0, phoneNumber.length).forEach(i -> this.phoneNumbers[i] = phoneNumber[i]);
    }

    private boolean nameCheck(String string) {
        return string.matches("[a-zA-Z0-9]{5,10}");
    }

    private boolean phoneNumberCheck(String string) {
        return string.matches("07[0125678][0-9]{6}");
    }
...
class PhoneBook implements Serializable {
    ...
    public void addContact(Contact c) throws MaximumSizeExceededException, InvalidNameException {
...
public class PhonebookTester {
    ...
    private static void testContact(Scanner jin) throws Exception {
        ...
        System.out.println(Arrays.toString(contact.getPhoneNumbers()));
